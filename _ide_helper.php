 ...
 * Generated for Laravel 6.18.1 on 2020-03-11 19:16:38.
 *
...
namespace Orchid\Support\Facades { 
    ...
    class Alert {
         ...
         * @static 
         */ 
        public static function view($template, $level = 'info', $data = [])
        {
                        /** @var \Orchid\Alert\Alert $instance */
    ...
    class Dashboard {
         ...
         * 
         *
         * @param \Orchid\Platform\Model[] $value
         * @return \Orchid\Platform\Dashboard 
         * @static 
         */ 
        public static function registerGlobalSearch($value)
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->registerGlobalSearch($value);
        }
        ...
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->getGlobalSearch();
        }
